# src/core/models/chatbot_runtime.py
import os
import json
import pickle
import re
...
NN_THRESHOLD = 0.50
SEM_THRESHOLD = 0.40
MAX_LEN = 24  # debe coincidir con el entrenamiento
RANDOM_SEED = 42
...
# Paths adaptados
# =============================
ROOT_DIR = Path(__file__).resolve().parents[3]  # llega a nexusChatBot/
DATA_DIR = ROOT_DIR / "data"
ARTIFACTS_DIR = ROOT_DIR / "artifacts"

INTENTS_PATH = DATA_DIR / "nexus_data.json"
TOKENIZER_PATH = ARTIFACTS_DIR / "tokenizer.pkl"
LABELENC_PATH = ARTIFACTS_DIR / "label_encoder.pkl"
MODEL_PATH = ARTIFACTS_DIR / "chatbot_model.h5"
